...
var initialOpmltext = "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?><opml version=\"2.0\"><head><title>Undefined</title></head><body><outline text=\"\"/></body></opml>";
//var initialOpmltext = "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?><opml version=\"2.0\"><head><title>" + posttitle + "</title></head><body><outline text=\"\"/></body></opml>";
...
//op glue routines
	...
	function opOutlineToXml (aTitle, ownerName, ownerEmail, ownerId) {
		return ($(defaultUtilsOutliner).concord ().op.outlineToXml (aTitle, ownerName, ownerEmail, ownerId));
		}
